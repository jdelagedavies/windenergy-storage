class WindTurbine:
    ...
    def calc_coefficient_performance(self, wind_speed):
        ...
        # then the coefficient of power is 0.
    ...
    def calc_air_density(self, air_pressure, air_temperature, relative_humidity):
        ...
        # The polynomial was fitted from the Smithsonian Meteorological Tables by Roland List (6th ed).
        # Source : https://www.emd.dk/files/windpro/WindPRO_AirDensity.pdf

        c = [0.99999683e0, -0.90826951e-2, 0.78736169e-4, -0.61117958e-6, 0.43884187e-8,
             -0.29883885e-10, 0.21874425e-12, -0.17892321e-14, 0.11112018e-16, -0.30994571e-19]

        temperature_approximating_polynomial = 0
        for i in range(len(c)):
            temperature_approximating_polynomial += c[i]*(air_temperature**i)

        saturation_vapor_pressure = 6.1078 / \
            (temperature_approximating_polynomial ** 8)
